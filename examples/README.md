...
| # | File | Description |
|---|------|-------------|
| 1 | [01_quickstart.py](01_quickstart.py) | Simplest agent — ask a question, get an answer |
| 2 | [02_tools.py](02_tools.py) | Agent with file/shell/git tools — writes and runs code |
| 3 | [03_structured_output.py](03_structured_output.py) | Get validated Pydantic models from agents |
...
# Interactive CLI agent from YAML
